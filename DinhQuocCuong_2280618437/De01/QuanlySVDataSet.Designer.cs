...
namespace De01 {
    ...
    public partial class QuanlySVDataSet : global::System.Data.DataSet {
        ...
        public partial class SinhvienDataTable : global::System.Data.TypedTableBase<SinhvienRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public SinhvienRow AddSinhvienRow(string MaSV, string HotenSV, LopRow parentLopRowByFK__Sinhvien__MaLop__59FA5E80, System.DateTime NgaySinh) {
                ...
                if ((parentLopRowByFK__Sinhvien__MaLop__59FA5E80 != null)) {
                    columnValuesArray[2] = parentLopRowByFK__Sinhvien__MaLop__59FA5E80[0];
                }
...
namespace De01.QuanlySVDataSetTableAdapters {
    ...
    public partial class SinhvienTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.DeleteCommand.Connection = this.Connection;
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Sinhvien] WHERE (([MaSV] = @Original_MaSV) AND ((@IsNull_HotenSV = 1 AND [HotenSV] IS NULL) OR ([HotenSV] = @Original_HotenSV)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)))";
            this._adapter.DeleteCommand.CommandType = global::System.Data.CommandType.Text;
            ...
            this._adapter.InsertCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.InsertCommand.Connection = this.Connection;
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Sinhvien] ([MaSV], [HotenSV], [MaLop], [NgaySinh]) VALUES (@Ma" +
                "SV, @HotenSV, @MaLop, @NgaySinh);\r\nSELECT MaSV, HotenSV, MaLop, NgaySinh FROM Si" +
            ...
            this._adapter.UpdateCommand = new global::System.Data.SqlClient.SqlCommand();
            this._adapter.UpdateCommand.Connection = this.Connection;
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Sinhvien] SET [MaSV] = @MaSV, [HotenSV] = @HotenSV, [MaLop] = @MaLop, [NgaySinh] = @NgaySinh WHERE (([MaSV] = @Original_MaSV) AND ((@IsNull_HotenSV = 1 AND [HotenSV] IS NULL) OR ([HotenSV] = @Original_HotenSV)) AND ((@IsNull_MaLop = 1 AND [MaLop] IS NULL) OR ([MaLop] = @Original_MaLop)) AND ((@IsNull_NgaySinh = 1 AND [NgaySinh] IS NULL) OR ([NgaySinh] = @Original_NgaySinh)));
SELECT MaSV, HotenSV, MaLop, NgaySinh FROM Sinhvien WHERE (MaSV = @MaSV)";
            this._adapter.UpdateCommand.CommandType = global::System.Data.CommandType.Text;
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[0].Connection = this.Connection;
            this._commandCollection[0].CommandText = "SELECT MaSV, HotenSV, MaLop, NgaySinh FROM dbo.Sinhvien";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
        }
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Delete, true)]
        public virtual int Delete(string Original_MaSV, string Original_HotenSV, string Original_MaLop, global::System.Nullable<global::System.DateTime> Original_NgaySinh) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Insert, true)]
        public virtual int Insert(string MaSV, string HotenSV, string MaLop, global::System.Nullable<global::System.DateTime> NgaySinh) {
            if ((MaSV == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string MaSV, string HotenSV, string MaLop, global::System.Nullable<global::System.DateTime> NgaySinh, string Original_MaSV, string Original_HotenSV, string Original_MaLop, global::System.Nullable<global::System.DateTime> Original_NgaySinh) {
            if ((MaSV == null)) {
                throw new global::System.ArgumentNullException("MaSV");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string HotenSV, string MaLop, global::System.Nullable<global::System.DateTime> NgaySinh, string Original_MaSV, string Original_HotenSV, string Original_MaLop, global::System.Nullable<global::System.DateTime> Original_NgaySinh) {
            return this.Update(Original_MaSV, HotenSV, MaLop, NgaySinh, Original_MaSV, Original_HotenSV, Original_MaLop, Original_NgaySinh);
        }
    }
